        ...
        <div class="col-md-6 col-lg-5">
            <div class="bg-white p-5 rounded-4 shadow-sm text-center" style="border: 1px solid var(--border-light);">
                ...
                <div class="d-grid gap-3 mt-4">
                    <a href="{{ asset('apk/METRA.apk') }}" class="btn btn-dark fw-bold rounded-pill p-3 d-flex align-items-center justify-content-center" style="background: var(--black-primary); font-size: 1.05rem;" download>
