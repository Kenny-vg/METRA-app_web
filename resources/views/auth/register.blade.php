        ...
        <div class="login-card text-center" style="border-top: 5px solid var(--ambar);">
            ...
            <form action="{{ route('register') }}" method="POST">
                @csrf <div class="text-start mb-3">
                    <label class="form-label small fw-bold" style="color: #4E342E;">Nombre Completo</label>
                ...
                <div class="text-start mb-4">
                    <label class="form-label small fw-bold" style="color: #4E342E;">Confirmar Contraseña</label>
